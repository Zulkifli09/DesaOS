<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.faqs.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded text-sm">
                + Tambah FAQ
            </a>
        </div>
    </x-slot>
                            ...
                            @forelse ($faqs as $faq)
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-500 line-clamp-2 mt-1">{{ strip_tags($faq->answer) }}</div>
                                    </td>
