<x-app-layout>
    ...
    <div class="py-12" x-data="{ mediaType: 'image' }">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="type" id="type" x-model="mediaType" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                <option value="image">Gambar (Foto)</option>
                                <option value="video">Video (YouTube/Link)</option>
                                <option value="drone">Drone / Panorama Udara (YouTube/Link)</option>
                            </select>
                        ...
                        <div x-show="mediaType === 'image'" x-transition>
                            <label class="block text-sm font-medium text-gray-700">Upload Gambar <span class="text-red-500">*</span></label>
                        ...
                        <div x-show="mediaType !== 'image'" x-transition style="display: none;">
                            ...
                            <input type="url" name="media_url" id="media_url" value="{{ old('media_url') }}" placeholder="Contoh: https://www.youtube.com/embed/xxxxxx" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            <p class="text-xs text-gray-500 mt-1">Disarankan menggunakan format Embed URL dari YouTube agar bisa langsung diputar di web.</p>
                        ...
                        <div class="flex items-center gap-6">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_downloadable" name="is_downloadable" type="checkbox" value="1" {{ old('is_downloadable') ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
