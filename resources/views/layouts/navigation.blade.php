<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.gallery_albums.index')" :active="request()->routeIs('admin.gallery_albums.*')">
                        {{ __('Album Galeri') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.galleries.index')" :active="request()->routeIs('admin.galleries.*')">
                        {{ __('Media Galeri') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.potentials.index')" :active="request()->routeIs('admin.potentials.*')">
                        {{ __('Potensi Desa') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.umkm.index')" :active="request()->request->routeIs('admin.umkm.*')">
                        {{ __('Lapak UMKM') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('admin.contact_messages.index')" :active="request()->routeIs('admin.contact_messages.*')">
                        {{ __('Pesan Masuk') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.gallery_albums.index')" :active="request()->routeIs('admin.gallery_albums.*')">
                {{ __('Album Galeri') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.galleries.index')" :active="request()->routeIs('admin.galleries.*')">
                {{ __('Media Galeri') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.potentials.index')" :active="request()->routeIs('admin.potentials.*')">
                {{ __('Potensi Desa') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('admin.contact_messages.index')" :active="request()->routeIs('admin.contact_messages.*')">
                {{ __('Pesan Masuk') }}
            </x-responsive-nav-link>
        </div>
